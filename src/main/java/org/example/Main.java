...
public class Main {
    public static void main(String[] args) {
        System.out.println(new Main().longestCommonPrefix(new String[]{"flower","flow","flight"})); // "fl"
        System.out.println(new Main().longestCommonPrefix(new String[]{"dog","racecar","car"})); // ""
    }
